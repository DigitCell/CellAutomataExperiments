...
/***/ "./project/src/compute_shaders/compute3.wgsl":
/*!***************************************************!*\
  !*** ./project/src/compute_shaders/compute3.wgsl ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _shaders_vert_wgsl__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./shaders/vert.wgsl */ "./project/src/shaders/vert.wgsl");
/* harmony import */ var _shaders_frag_wgsl__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./shaders/frag.wgsl */ "./project/src/shaders/frag.wgsl");
/* harmony import */ var _compute_shaders_compute3_wgsl__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./compute_shaders/compute3.wgsl */ "./project/src/compute_shaders/compute3.wgsl");
...
class Graphics {
    constructor() {
        ...
        this.renderFrame = () => {
            ...
            passEncoderCompute.dispatchWorkgroups((this.GameOptions.width * this.GameOptions.height) / this.GameOptions.workgroupSize);
    ...
    initializeWebGPU() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const gpuObject = yield navigator.gpu;
            if (!gpuObject) {
                throw Error("WebGPU not supported.");
                return false;
            }
            const adapter = yield gpuObject.requestAdapter();
            if (!adapter) {
    ...
    initializeComputeBuffers() {
        ...
        const dataArray2 = [Object.assign({}, this.CellUniform)];
    ...
    initializeComputePipline() {
        const computeShader = this.device.createShaderModule({ code: _compute_shaders_compute3_wgsl__WEBPACK_IMPORTED_MODULE_3__["default"] });
    ...
    initializeRenderPipline() {
        const vertexShader = this.device.createShaderModule({ code: _shaders_vert_wgsl__WEBPACK_IMPORTED_MODULE_1__["default"] });
        const fragmentShader = this.device.createShaderModule({ code: _shaders_frag_wgsl__WEBPACK_IMPORTED_MODULE_2__["default"] });
        const squareStride = {
...
/*!******************************!*\
  ...
  \******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _graphicClass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./graphicClass */ "./project/src/graphicClass.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
function start() {
    return __awaiter(this, void 0, void 0, function* () {
        const graphics = new _graphicClass__WEBPACK_IMPORTED_MODULE_0__.Graphics();
        yield graphics.init();
        graphics.runLoop();
    });
}
